...
const u16  DMA_JUDGE_RECEIVE_BUF_SIZE = 1000	;//接受缓存区数据的长度
const u16  DMA_JUDGE_SEND_BUF_SIZE 	= 1000	;//发送缓存区数据长度
...
u8 g_dma_minipc_send_buff[DMA_MINIPC_SEND_BUFF_SIZE]={0};//视觉发送缓冲
u8 g_dma_minipc_receice_buff[DMA_MINIPC_REVE_BUFF_SIZE]={0};//视觉接受缓冲
