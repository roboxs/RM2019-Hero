...
#define GIMBAL_TASK_CYCLE 1

#define GIMBAL_YAW_MID_ANGLE  90.0f
#define GIMBAL_YAW_MAX_ANGLE  50.0f //右
#define GIMBAL_YAW_MIN_ANGLE  130.0f //左

#define GIMBAL_PITCH_MID_ANGLE 152.0f
#define GIMBAL_PITCH_MIN_ANGLE 168.0f//上
#define GIMBAL_PITCH_MAX_ANGLE 130.0f//下
...
#define YAW_OUTER_I_INIT -0.12
#define YAW_OUTER_D_INIT -400
...
#define PITCH_OUTER_I_INIT  -0.5
#define PITCH_OUTER_D_INIT  -400
#define PITCH_OUTER_MAXOUT_INIT				 3000
